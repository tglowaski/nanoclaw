...
function buildVolumeMounts(
  ...
  // Mount trading tools source — also recompiled on container startup.
  const toolsSrc = path.join(projectRoot, 'container', 'tools');
  mounts.push({
    hostPath: toolsSrc,
    containerPath: '/app/tools',
    readonly: true,
  });
...
function buildContainerArgs(
  ...
  // Trading tools: sidecar URL and store directory
  args.push('-e', 'SIDECAR_URL=http://host.docker.internal:9200');
  args.push('-e', 'STORE_DIR=/workspace/project/store');
